namespace SenSÉ.Shell.Localization;
...
public static class Translations
{
    public static readonly Dictionary<string, string> English = new(StringComparer.Ordinal)
    {
        ...
        ["Une autre manette occupe l'emplacement XInput 0, celui que les jeux lisent pour le joueur 1. La manette virtuelle de SenSÉ se retrouve après elle et n'est pas lue. Éteignez les autres manettes puis relancez le jeu."]
            = "Another controller holds XInput slot 0, the one games read for player one. SenSÉ's virtual pad ends up behind it and is never read. Turn the other controllers off, then restart the game.",
        ["Curseurs"] = "Cursors",
        ...
        ["Ces réglages modifient Windows, pas seulement SenSÉ. L'état d'origine est sauvegardé avant la première modification et peut être restauré à tout moment."]
            = "These settings change Windows itself, not only SenSÉ. The original state is saved before the first change and can be restored at any time.",
        ...
        ["Calculatrice scientifique de SenSÉ"] = "SenSÉ scientific calculator",
        ["Gestionnaire des taches"] = "Task manager",
        ["Processus et performances"] = "Processes and performance",
        ["Parametres SenSÉ"] = "SenSÉ settings",
        ["Paramètres SenSÉ"] = "SenSÉ settings",
        ...
        ["Maintenez Menu et View ensemble pendant 3 secondes. SenSÉ débranche la manette virtuelle puis s'arrête proprement : ce n'est pas traité comme une déconnexion accidentelle."]
            = "Hold Menu and View together for 3 seconds. SenSÉ unplugs the virtual controller and exits cleanly: this is not treated as an accidental disconnection.",
        ...
        ["Aucun actionneur de gâchette n'est confirmé sur ce firmware. Lancez « SenSÉ.Core.exe haptic-probe » pour le savoir, puis renseignez l'index trouvé."]
            = "No trigger actuator has been confirmed on this firmware. Run “SenSÉ.Core.exe haptic-probe” to find out, then enter the index it reports.",
        ["Profil"] = "Profile",
        ["Nouveau"] = "New",
        ["Les boutons Steam et Quick Access ne sont pas remappables : ils pilotent SenSÉ lui-même."]
            = "The Steam and Quick Access buttons cannot be remapped: they drive SenSÉ itself.",
        ...
        ["L'apparence par défaut de SenSÉ."] = "The default SenSÉ look.",
