...
/// <summary>
/// Detects the two kernel drivers SenSÉ depends on: ViGEmBus and HidHide.
/// </summary>
/// <remarks>
/// Detection is deliberately version-agnostic. It asks whether the driver service is registered and
/// then reports whatever version it finds; it never compares against a version SenSÉ was built
