...
/// hive, so no administrator rights are needed and no file is left behind anywhere SenSÉ does
...
public static class CursorInstaller
{
    ...
    /// <summary>Restores the cursors Windows had before SenSÉ touched them.</summary>
