...
/// <summary>
/// What the control centre offers: SenSÉ's own tools, then shortcuts into Windows.
/// </summary>
/// <remarks>
/// The grid is composed from two lists rather than written out by hand, because the two halves are
/// not the same kind of thing.
///
/// The tools come from <see cref="ToolRegistry"/>. They belong to SenSÉ, and each is one field
...
public static class QuickActions
{
    ...
    /// SenSÉ tourne restait donc invisible jusqu'au redémarrage suivant, ce qui contredit la
