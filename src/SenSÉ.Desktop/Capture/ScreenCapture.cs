...
/// </summary>
/// <remarks>
/// SenSÉ's own capture rather than Win+Shift+S. The Windows tool opens its own window and takes
...
public static class ScreenCapture
{
    ...
    public static string Folder => Path.Combine(
        Environment.GetFolderPath(Environment.SpecialFolder.MyPictures), "SenSÉ");
