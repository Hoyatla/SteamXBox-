...
public sealed class PanneauOutil : UserControl
{
    ...
    public PanneauOutil(PluginManifest manifeste, Action<string>? journal)
    {
        ...
        _manifeste = SenSÉ.Tools.Generation.OptionsVivantes.Resoudre(manifeste, journal);
        _journal = journal;
    ...
    {
        var racine = SenSÉ.Tools.Modeles.JeuxModeles.Racine;
    ...
    private Button Bouton(PluginContentItem item)
    {
        ...
        // sur le fil d'affichage c'est soixante et onze secondes de SenSÉ figé — plein écran,
