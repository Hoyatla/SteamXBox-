...
public static class ClipboardService
{
    ...
    public static void Start()
    {
        ...
        var parameters = new HwndSourceParameters("SenSÉClipboard")
        {
        ...
        // by the time the clipboard window is open, SenSÉ is the foreground and the answer is
    ...
    /// thirty-three seconds, until SenSÉ was closed. The hook has its own thread now; this one
