...
public static class DesktopWindows
{
    ...
    /// </summary>
    /// <remarks>
    /// The count above lives in memory and dies with the process. Everything else SenSÉ leaves
    ...
    /// note had to move there: a marker next to the executable belongs to one copy of SenSÉ, and
    ...
    /// <summary>
    /// Puts the windows back if SenSÉ is the reason they are down.
    /// </summary>
    /// <remarks>
    ...
    /// they were not given back when SenSÉ exited. Releasing our side with
