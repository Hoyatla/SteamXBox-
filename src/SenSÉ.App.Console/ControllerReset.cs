...
/// state neither Steam nor SenSÉ chose, and the symptom is a pad that does nothing recognisable
...
/// that whatever SenSÉ applies next is applied to a device in a state it recognises.
/// </para>
///
/// <para>
/// <b>Opened and closed here.</b> The reclaim happens between two sessions of reading, at a moment
/// when nothing holds the device: the source that read it was disposed when SenSÉ stood down,
