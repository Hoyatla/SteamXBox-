...
/// <summary>
/// The document converter SenSÉ borrows rather than carries.
/// </summary>
/// <remarks>
...
public static class LibreOffice
{
    ...
    {
        // Ce que SenSÉ héberge d'abord. Un LibreOffice accueilli dans Outils appartient au
    ...
    public static Result Convert(string input, string format, string outputDirectory, Action<string>? log = null)
    {
        ...
        lock (Gate)
        {
        var workspace = Path.Combine(Path.GetTempPath(), "SenSÉ.Convert", "profile");
