...
public static class XboxControllerDefaults
{
    ...
    /// Construite au premier acces et non par l'initialiseur de type, pour la raison ecrite dans
    /// <c>SteamControllerDefaults.Deferred</c>.
    /// </para>
    ...
    /// <see cref="SenSÉProfileSettings"/> depuis un initialiseur de type ferme un cycle, et
