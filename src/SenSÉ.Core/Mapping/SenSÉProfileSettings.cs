...
public sealed record SenSÉProfileSettings
{
    /// <summary>
    ...
    /// </para>
    /// </remarks>
    public static SenSÉProfileSettings Bare { get; } = new()
    {
    ...
    /// </para>
    public static SenSÉProfileSettings DefaultFor(Input.ControllerKind kind) => kind switch
    {
    ...
    /// </remarks>
    public static SenSÉProfileSettings Default => SteamControllerDefaults.Settings;
