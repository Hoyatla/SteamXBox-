...
public sealed class ProfileMapper
{
	...
	private readonly SenSÉProfileSettings _settings = SenSÉProfileSettings.Default;
	...
	public SenSÉProfileSettings Settings => _settings;

	public ProfileMapper() : this(SenSÉProfileSettings.Default) { }

	public ProfileMapper(SenSÉProfileSettings settings)
	{
		_settings = settings;
	...
	public static SenSÉProfileSettings LoadFromProfilesDirectory(string profileName)
	{
	...
	public static ProfileLoadResult LoadDetailed(string profileName)
	{
		...
		var defaults = SenSÉProfileSettings.Default;
