...
public static class SearchRanking
{
    ...
    /// are: <c>D, steamxbox</c> should find
    /// <c>D:\…\SteamXBox-portable-win-x64\SteamXBox.exe</c> without anyone spelling out the middle.
    ///
    /// <para>
    ...
    /// is kept — <c>D:</c> matches the path while <c>steamxbox</c> matches the name, and neither
