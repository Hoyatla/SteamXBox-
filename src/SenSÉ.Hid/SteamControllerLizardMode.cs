...
public static class SteamControllerLizardMode
{
    ...
    /// SenSÉ that dies leaves the controller to fix itself within a second, with nothing to
    ...
    /// fine, broken enough to be useless, and nothing on screen to connect that to SenSÉ.
    /// </para>
    ///
    /// <para>
