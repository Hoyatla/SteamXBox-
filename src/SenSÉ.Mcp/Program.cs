...
// Serveur MCP de SenSÉ — lecture seule.
//
...
static JsonNode ListerOutils() => new JsonObject
{
    ["tools"] = new JsonArray(
        new JsonObject
        {
            ...
            ["description"] = "Liste les outils de l'environnement SenSÉ, tels que leurs manifestes les declarent.",
        ...
        {
            ["name"] = "etat_produit",
            ["description"] = "Version de SenSÉ, manettes connues et fichiers d'etat presents.",
            ["inputSchema"] = new JsonObject
            {
                ["type"] = "object",
                ["properties"] = new JsonObject(),
        ...
        new JsonObject
        {
            ...
            ["description"] = "Les manettes que SenSÉ tient en ce moment. Demande que le produit soit lance.",
            ["inputSchema"] = new JsonObject
            {
                ["type"] = "object",
                ["properties"] = new JsonObject(),
...
static JsonNode Appeler(JsonNode? parametres, string racine)
{
    ...
    return nom switch
    {
        ...
        "manettes_connectees" => Texte(SenSÉ.Mcp.Produit.Demander("manettes")),
...
static string EtatProduit(string racine)
{
    ...
    var executable = Path.Combine(racine, "SenSÉ.exe");
    ...
    {
        lignes.Add("SenSÉ.exe absent de ce dossier.");
    }
