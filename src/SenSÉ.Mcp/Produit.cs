...
/// <summary>
/// Le client du tuyau : ce qui parle à SenSÉ en cours d'exécution.
/// </summary>
/// <remarks>
...
/// HidHide et LibreOffice : ce qui manque est nommé, jamais tu. Un modèle qui reçoit « SenSÉ
...
internal static class Produit
{
    ...
    private const string Tuyau = "SenSÉ-mcp";
    ...
    public static string Demander(string question)
    {
        try
        {
            ...
            {
                return "SenSÉ n'est pas lancé : cette information n'est disponible que quand le produit tourne.";
            }
            ...
            return lecteur.ReadLine()?.Replace("\\n", "\n") ?? "SenSÉ a raccroché sans répondre.";
        }
