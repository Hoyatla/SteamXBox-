...
public enum PluginCategory
{
    ...
    /// <summary>SenSÉ's own windows: acrylic, mica, transitions.</summary>
    ThemeSurface,
    ...
    /// <c>SenSÉ.Desktop</c> supplies the window, the theme, the controller navigation and the
    ...
    /// de ce qui peut manquer à SenSÉ n'est pas dans SenSÉ — ffmpeg, LibreOffice, un Python.
...
/// for whoever installs SenSÉ — not something to paper over with a default.
/// </remarks>
public static class PluginCatalog
{
    ...
    public static string? Validate(PluginManifest manifest)
    {
        ...
        // The rule the contract exists for. Without a way back, uninstalling SenSÉ would leave
    ...
    /// no way to tell that from a bug in SenSÉ.
    /// </remarks>
