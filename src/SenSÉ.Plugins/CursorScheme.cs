...
/// cursors into <c>%WINDIR%\Cursors</c>, which needs administrator rights; SenSÉ does not do
...
public static class CursorSchemeParser
{
    ...
    public static CursorScheme Parse(string inf)
    {
        ...
        foreach (var raw in inf.Split('\n'))
        {
            ...
            {
                // The Schemes subkey registers the pack in the mouse control panel. SenSÉ does
