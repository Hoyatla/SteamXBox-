...
/// </summary>
/// <remarks>
/// Première pièce du protocole d'hébergement : un outil extérieur ne demande pas à SenSÉ où
/// écrire, il l'apprend par son environnement — et c'est SenSÉ qui le lui compose. Le
