...
/// <summary>
/// Keeps a list of the device nodes SteamXBox's own virtual pads have occupied.
/// </summary>
/// <remarks>
...
/// declined. SteamXBox creates a virtual Xbox pad each time it enters Xbox mode, and each one leaves
...
///
/// <para>
/// They are not harmless. SteamXBox matches an XInput slot to a physical pad by enumerating XUSB
...
/// administrator, and SteamXBox deliberately does not ask for it. So this records during ordinary
...
{
    /// <summary>Beside the other state SteamXBox keeps for the user, not in the program folder.</summary>
    /// <remarks>
