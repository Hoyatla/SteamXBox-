...
/// </summary>
/// <remarks>
/// The slot comes from the controller's <see cref="Sc2Xboxed.Core.Input.ControllerIdentity"/>, which
/// <see cref="XInputControllerSource"/> pinned to the slot it reads — so the pad a game vibrates and
/// the pad that actually shakes are the same device. The virtual pad SteamXBox serves the game never
