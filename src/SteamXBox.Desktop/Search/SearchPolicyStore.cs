...
/// <list type="bullet">
/// <item>
/// <c>%ProgramData%\SteamXBox\policy.json</c> — the administrator's. That directory is writable only
...
/// </item>
/// <item>
/// <c>%LOCALAPPDATA%\SteamXBox\search.json</c> — the user's own, alongside their profiles.
/// </item>
/// </list>
///
/// <para>
