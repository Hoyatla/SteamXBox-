...
/// <summary>
/// Starts and stops the processes that make up SteamXBox.
/// </summary>
/// <remarks>
...
/// </remarks>
internal static class SteamXBoxProcesses
{
    private const string Core = "SteamXBox.Core";
    private const string Overlay = "Sc2Xboxed.Osk";
    private const string Configuration = "SteamXBox";
    ...
    /// <summary>
    /// Shuts down everything that belongs to SteamXBox.
    /// </summary>
    /// <remarks>
    ...
    {
        UiLog.Info("stopping every SteamXBox process");
        SignalOverlayExit();
    ...
    private static Process[] SafeProcesses(string name)
    {
        try
        {
            // Never this process: Desktop is called SteamXBox.Desktop, which does not match, but a
