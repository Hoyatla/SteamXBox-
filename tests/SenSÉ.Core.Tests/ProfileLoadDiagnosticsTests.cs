...
public sealed class ProfileLoadDiagnosticsTests
{
    ...
    public void MissingProfileStillYieldsUsableDefaults()
    {
        ...
        Assert.Equal(SenSÉProfileSettings.Default, result.Settings);
    }

    [Fact]
    public void EffectiveSettingsFlagAnAbsurdScrollSensitivity()
    {
        var settings = SenSÉProfileSettings.Default with
        {
    ...
    {
        var report = string.Join("\n", SessionReport.EffectiveSettings(SenSÉProfileSettings.Default));
