...
public sealed class SteamPresenceWatcherTests
{
    ...
    [Fact]
    public void SenSÉOwnsTheControllerWhileSteamIsAbsent()
    {
        ...
        Assert.Equal(ControllerOwner.SenSÉ, watcher.Owner);
    }
    ...
    public void TakingOwnershipSkipsTheGraceEntirely()
    {
        ...
        // SenSÉ killed Steam itself, so there is nothing to wait for.
        running = false;
