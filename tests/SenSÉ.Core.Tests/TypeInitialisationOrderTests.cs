...
/// <c>SenSÉProfileSettings.Bare with { ... }</c>, et l'initialiseur d'instance de cet
...
{
    private const string SettingsTypeName = "SenSÉ.Core.Mapping.SenSÉProfileSettings";
    private const string SteamTypeName = "SenSÉ.Core.Mapping.SteamControllerDefaults";
    private const string Ps5TypeName = "SenSÉ.Core.Mapping.Ps5ControllerDefaults";
    private const string XboxTypeName = "SenSÉ.Core.Mapping.XboxControllerDefaults";
    private const string MapTypeName = "SenSÉ.Core.Mapping.XboxButtonMap";

    /// <summary>Une copie fraiche de SenSÉ.Core, statiques comprises.</summary>
    private sealed class FreshCopy : AssemblyLoadContext, IDisposable
    {
        ...
        public FreshCopy()
            ...
            => _core = LoadFromAssemblyPath(Beside("SenSÉ.Core.dll"));
