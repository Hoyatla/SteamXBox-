...
".\SenSÉ.Core.exe" hid-list | findstr /i /c:"No Valve HID device found." >nul
if not errorlevel 1 (
  echo =====================================
...
echo.
echo =====================================
echo [RESTART] SenSÉ s'est arrete avec le code %APP_EXIT%.
echo [RESTART] Relance dans %RESTART_DELAY_SECONDS% secondes. Utilisez Stop-SenSÉ.cmd pour l'arret volontaire.
ping -n %PING_DELAY_COUNT% 127.0.0.1 >nul
goto WAIT_FOR_DEVICE
...
:NORMAL_EXIT
echo =====================================
echo [STOP] SenSÉ s'est ferme normalement. Pas de relance automatique.
exit /b 0
