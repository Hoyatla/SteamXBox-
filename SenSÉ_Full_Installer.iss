; SenSÉ Portable - Installeur Complet "Un Clic"
; Inclut: SenSÉ + ViGEmBus + HidHide (drivers signés Microsoft)
; Compile: iscc SenSÉ_Full_Installer.iss

#define MyAppName "SenSÉ"
#define MyAppVersion "0.5.0"
#define MyAppPublisher "Hoyatla"
#define MyAppURL "https://github.com/Hoyatla/SenSÉ-Explorer"
#define MyAppExeName "SenSÉ.exe"
...
OutputDir=dist
OutputBaseFilename=SenSÉ_Full_Setup_{#MyAppVersion}_win-x64
SetupIconFile=SenSÉ.ico
Compression=lzma
...
UninstallDisplayIcon={app}\SenSÉ.ico
...
; Sans eux, SenSÉ fonctionne : les fonctions concernees se detectent absentes et le disent.
...
[Files]
; SenSÉ executables (self-contained single-file)
Source: "SenSÉ.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "SenSÉ.Core.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "SenSÉSteam.Osk.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "SenSÉPS5.Osk.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "SenSÉXbox.Osk.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "SenSÉ.Desktop.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "SenSÉ.Indexer.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "SenSÉ-Moniteur.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "SenSÉ.Mcp.exe"; DestDir: "{app}"; Flags: ignoreversion

; Scripts
Source: "Stop-SenSÉ.cmd"; DestDir: "{app}"; Flags: ignoreversion
...
; Icon
Source: "SenSÉ.ico"; DestDir: "{app}"; Flags: ignoreversion
...
; encode le fabricant et le produit : "Hoyatla_SenSÉ_Updater.exe" construit l'adresse
; .../api/Hoyatla/SenSÉ/updates.json.
;
...
Source: "updater\Hoyatla_SenSÉ_Updater.exe"; DestDir: "{app}"; Flags: ignoreversion skipifsourcedoesntexist
Source: "updater\Hoyatla_SenSÉ_Updater.json"; DestDir: "{app}"; Flags: ignoreversion skipifsourcedoesntexist
...
Root: HKLM; Subkey: "SOFTWARE\Hoyatla\SenSÉ"; ValueType: string; ValueName: "Version"; \
...
Root: HKCU; Subkey: "Software\Microsoft\Windows\CurrentVersion\Run"; ValueType: string; \
    ValueName: "SenSÉ"; Flags: dontcreatekey uninsdeletevalue

[Icons]
Name: "{group}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"; IconFilename: "{app}\SenSÉ.ico"
Name: "{group}\{cm:UninstallProgram,{#MyAppName}}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"; IconFilename: "{app}\SenSÉ.ico"; Tasks: desktopicon
...
; livrer avec un produit ferme exposerait le code de SenSÉ. Pour LibreOffice et Tesseract, c'est
...
; de session suivante.
Filename: "{app}\Hoyatla_SenSÉ_Updater.exe"; Parameters: "--install"; StatusMsg: "Enregistrement des mises a jour automatiques..."; Flags: runhidden waituntilterminated skipifdoesntexist
...
Filename: "{app}\Hoyatla_SenSÉ_Updater.exe"; Parameters: "--uninstall"; Flags: runhidden skipifdoesntexist; RunOnceId: "RemoveUpdater"
...
Filename: "{app}\SenSÉ.Core.exe"; Parameters: "stop"; Flags: runhidden; RunOnceId: "StopCore"
Filename: "{app}\SenSÉ.Core.exe"; Parameters: "hidhide-off"; Flags: runhidden; RunOnceId: "ReleasePads"

; Les traces des manettes virtuelles que SenSÉ a creees. Windows enregistre tout appareil apparu
...
; accumules, et SenSÉ qui renonce a associer un slot XInput a une manette faute de pouvoir les
; distinguer.
;
...
; l'emulation.
Filename: "{app}\SenSÉ.Core.exe"; Parameters: "pads-cleanup"; Flags: runhidden; RunOnceId: "CleanPadRecords"
...
begin
  Result := True;
  Backup := ExpandConstant('{localappdata}\SenSÉ\windows-state-backup.json');

  if FileExists(Backup) then
  begin
    if MsgBox('SenSÉ a remplace les curseurs de Windows.' + #13#10#13#10 +
